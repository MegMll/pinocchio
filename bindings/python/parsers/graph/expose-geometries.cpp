  ...
  namespace python
  {
    ...
    void exposeGeometriesVariant()
    {
      ...
      bp::class_<pinocchio::graph::Cylinder>("Cylinder", "Represents a cylinder.", bp::init<>())
        ...
        .def_readwrite(
          "size", &pinocchio::graph::Cylinder::size, "Size of the cylinder (radius, height).");
      ...
      bp::class_<pinocchio::graph::Capsule>("Capsule", "Represents a capsule.", bp::init<>())
        ...
        .def_readwrite(
          "size", &pinocchio::graph::Capsule::size, "Size of the capsule (radius, length).");
    ...
    void exposeGeometryGraph()
    {
      ...
      bp::class_<pinocchio::graph::Geometry>(
        "Geometry", "Main geometry object containing all properties for the Model Graph.",
        bp::init<>())
        .def(bp::init<
             const std::string &, const pinocchio::SE3 &, const pinocchio::graph::GeomType &,
             const Eigen::Vector3d &, const Eigen::Vector4d &,
             const pinocchio::graph::GeomVariant &>(
        ...
        .def_readwrite(
          "type", &pinocchio::graph::Geometry::type, "Type of geometry (VISUAL, COLLISION, BOTH).")
        ...
        .def_readwrite(
          "placement", &pinocchio::graph::Geometry::placement,
          "SE3 placement (pose) of the geometry wrt to the body.")
        .def_readwrite(
          "geometry", &pinocchio::graph::Geometry::geometry, "The actual geometric primitive.");
    ...
    void exposeGeometryBuilder()
    {
      ...
      bp::class_<pinocchio::graph::GeometryBuilder>(
        "GeometryBuilder", "A builder for Geometries in Model Graph.",
        bp::init<pinocchio::graph::ModelGraph &>((bp::arg("model_graph"))))
        .def(
          "withName", &pinocchio::graph::GeometryBuilder::withName, bp::return_self<>(),
          (bp::arg("name")), "Sets the name of the geometry.")
        .def(
          "withBody", &pinocchio::graph::GeometryBuilder::withBody, bp::return_self<>(),
          (bp::arg("body_name")), "Sets the name of the body this geometry is attached to.")
        .def(
          "withPlacement", &pinocchio::graph::GeometryBuilder::withPlacement, bp::return_self<>(),
          (bp::arg("placement")), "Sets the SE3 placement of the geometry.")
        .def(
          "withScale", &pinocchio::graph::GeometryBuilder::withScale, bp::return_self<>(),
          (bp::arg("scale")), "Sets the scale factors.")
        .def(
          "withColor", &pinocchio::graph::GeometryBuilder::withColor, bp::return_self<>(),
          (bp::arg("color")), "Sets the RGBA color.")
        .def(
          "withGeomType", &pinocchio::graph::GeometryBuilder::withGeomType, bp::return_self<>(),
          (bp::arg("geom_type")), "Sets the type of geometry (VISUAL, COLLISION, BOTH).")
        .def(
          "withGeom", &pinocchio::graph::GeometryBuilder::withGeom, bp::return_self<>(),
          (bp::arg("geometry_primitive")), "Sets the geometry primitive .")
        .def(
          "build", &pinocchio::graph::GeometryBuilder::build,
