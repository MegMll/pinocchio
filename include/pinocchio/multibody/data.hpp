...
namespace pinocchio
{
  ...
  , NumericalBase<DataTpl<_Scalar, _Options, JointCollectionTpl>>
  {
    ...
    /// \begin{bmatrix} ^{0}X_{1} S_{1} & \cdots & ^{0}X_{i} S_{i} & \cdots & ^{0}X_{\text{nvExtended}}
    /// S_{\text{nvExtended}} \end{bmatrix} \f$. This Jacobian has no special meaning. To get the jacobian
