    ...
    public:
      ...
      void visit(PyClass & cl) const
      {
        cl.def(bp::init<>(bp::arg("self"), "Default constructor. Constructs an empty model."))
          ...
          .add_property("nvExtended", &Model::nv, "Dimension of the jacobian matrix space.")
          ...
          .add_property(
            "idx_vExtendeds", &Model::idx_vExtendeds, "Starting index of the *i*th joint in the jacobian space.")
          .add_property("nvExtendeds", &Model::nvExtendeds, "Dimension of the *i*th joint jacobian subspace.")
          .add_property(
