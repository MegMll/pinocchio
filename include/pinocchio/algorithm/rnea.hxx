  ...
  namespace impl
  {
    ...
    : public fusion::JointUnaryVisitorBase<RneaBackwardStep<Scalar, Options, JointCollectionTpl>>
    {
        ...
        Data & data)
      {
        ...
        const JointIndex i = jmodel.id();
        const JointIndex parent = model.parents[i];
        // Mimic joint contributes to the torque of their primary and don't have their own
    ...
    : public fusion::JointUnaryVisitorBase<NLEBackwardStep<Scalar, Options, JointCollectionTpl>>
    {
        ...
        Data & data)
      {
        ...
        // Mimic joint contributes to the nle of their primary and don't have their own
        ...
        ComputeGeneralizedGravityBackwardStep<Scalar, Options, JointCollectionTpl>>
    {
        ...
        typename Data::VectorXs & g)
      {
        ...
        const JointIndex & i = jmodel.id();
        const JointIndex & parent = model.parents[i];
        // Mimic joint contributes to the gravity of their primary and don't have their own
